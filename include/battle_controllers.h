...
enum {
    ...
    REQUEST_LERATK_BATTLE,
    REQUEST_LERDEF_BATTLE,
    REQUEST_ARMOR_BATTLE,
    REQUEST_TRUDMG_BATTLE,
    REQUEST_GAMBIT_BATTLE,
    REQUEST_HOTSTRK_BATTLE,

    REQUEST_LERATK_IV_BATTLE,
    REQUEST_LERDEF_IV_BATTLE,
    REQUEST_ARMOR_IV_BATTLE,
    REQUEST_TRUDMG_IV_BATTLE,
    //REQUEST_GAMBIT_IV_BATTLE,
    REQUEST_HOTSTRK_IV_BATTLE,

    REQUEST_LERATK_EV_BATTLE,
    REQUEST_LERDEF_EV_BATTLE,
