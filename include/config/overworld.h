...
// Other settings
#define OW_POISON_DAMAGE                TRUE // In Gen4, Pokémon no longer faint from Poison in the overworld. In Gen5+, they no longer take damage at all.
...
#define OW_TIME_OF_DAY_FALLBACK         TIME_DAY // The time of day that encounter tables fall back to.
