...
#define FLAG_ENABLE_ROXANNE_FIRST_CALL       0x80 // Set after defeating Brawny. This will activate a call with Roxanne in order to register her.
...
#define FLAG_REGISTERED_BRAWNY               (TRAINER_REGISTERED_FLAGS_START + REMATCH_BRAWNY)
...
#define FLAG_ENABLE_BRAWNY_MATCH_CALL        0x1D4
