...
static const u16 sInitialRentalMonRanges[][2] = // or here
{
    // Level 50
    {FRONTIER_MON_SUNKERN,     FRONTIER_MON_CLOYSTER_2},   // 110 - 199
    {FRONTIER_MON_SUNKERN,     FRONTIER_MON_CLOYSTER_2}, // 162 - 266
    {FRONTIER_MON_DELCATTY_1, FRONTIER_MON_CLOYSTER_2}, // 267 - 371
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MON_SLAKING_4},  // 372 - 467
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MON_SLAKING_4},  // 468 - 563
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MON_SLAKING_4},  // 564 - 659
    {FRONTIER_MON_DUGTRIO_1,  FRONTIER_MONS_HIGH_TIER},  // 660 - 755
    {FRONTIER_MON_DUGTRIO_3,  NUM_FRONTIER_MONS - 1}, // 372 - 849

    // Open level
    {FRONTIER_MON_DELCATTY_2, FRONTIER_MON_SLAKING_4}, // 372 - 467
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_SLAKING_4}, // 468 - 563
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MONS_HIGH_TIER}, // 564 - 659
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1}, // 660 - 755
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_DUGTRIO_2, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_DUGTRIO_3, NUM_FRONTIER_MONS - 1},  // 372 - 881
};
