...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar  GYM1  SHOULEIL  LIGHT   FURRY    ON    MONEY    FAKE    KING    LANCE
    ...
    [TYPE_ON]       = {______, ______, X(2.0), X(2.0), ______, X(2.0), ______, ______, X(0.5), X(0.5), ______, X(2.0), X(0.0), X(2.0), X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, X(0.5), ______, ______},//[TYPE_ON]    
    [TYPE_MONEY]    = {______, ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},//[TYPE_MONEY] 
