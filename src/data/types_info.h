...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar  GYM1  SHOULEIL  LIGHT   FURRY    ON    MONEY    FAKE    KING    LANCE
    ...
    [TYPE_FIGHTING] = {______, X(2.0), X(2.0), X(0.5), X(0.5), ______, X(2.0), X(0.5), X(0.0), X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), ______, X(2.0), X(2.0), ______, X(0.5), ______, X(0.0), X(0.5), ______, ______},//[TYPE_FIGHTING
    [TYPE_FLYING]   = {______, ______, X(2.0), ______, ______, X(2.0), X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______},//[TYPE_FLYING]
    [TYPE_POISON]   = {______, X(2.0), ______, ______, X(0.5), X(0.5), ______, X(0.5), X(0.5), X(0.0), ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______, X(2.0), ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), ______},//[TYPE_POISON]
    ...
    [TYPE_ROCK]     = {______, ______, X(0.5), X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), X(2.0), ______, X(2.0), ______, ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, ______, X(2.0), ______, ______},//[TYPE_ROCK]  
    [TYPE_BUG]      = {______, ______, X(0.5), X(0.5), X(2.0), ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), X(0.5), ______, X(2.0), X(0.5), ______, X(2.0), X(0.0), X(0.5), X(2.0), ______, ______, ______, ______, ______},//[TYPE_BUG]   
    [TYPE_GHOST]    = {______, X(0.0), X(0.0), ______, ______, ______, ______, X(0.5), X(2.0), STL_RS, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______, ______, ______, X(0.0), ______, ______, ______, X(2.0), ______, ______},//[TYPE_GHOST] 
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, ______, X(0.5), X(2.0), X(0.5), X(2.0), ______, X(2.0), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, X(2.0), ______, X(2.0), X(0.0), X(0.5), X(2.0), X(2.0), X(2.0), ______, ______, X(0.5)},//[TYPE_FIRE]  
    [TYPE_WATER]    = {______, ______, ______, ______, X(2.0), X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), X(0.5), ______, X(0.5), X(0.5), ______, ______, ______, X(2.0), ______, X(2.0), ______, X(0.5), X(2.0), X(0.0), ______, ______},//[TYPE_WATER] 
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, X(0.5), ______, X(2.0), X(2.0), X(2.0), X(2.0), X(0.5), ______, ______, ______, X(0.5)},//[TYPE_GRASS] 
    [TYPE_ELECTRIC] = {______, ______, ______, X(2.0), ______, X(0.0), X(0.5), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, X(2.0), ______, ______, X(0.5), X(0.0), ______, ______, ______, ______, ______, X(0.5)},//[TYPE_ELECTRI
    [TYPE_PSYCHIC]  = {______, ______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______},//[TYPE_PSYCHIC
    [TYPE_ICE]      = {______, ______, ______, X(2.0), ______, X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(2.0), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, ______, ______, X(0.5), ______, X(0.0), ______, X(0.5), X(0.5), X(0.5), X(2.0)},//[TYPE_ICE]   
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, X(0.0), X(0.5), ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(2.0), ______, X(0.5), ______, ______, X(2.0), ______, X(0.5), X(2.0)},//[TYPE_DRAGON]
    [TYPE_DARK]     = {______, ______, X(0.5), X(2.0), ______, ______, ______, ______, X(2.0), STL_RS, ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(0.5), X(0.5), ______, ______, X(0.5), X(0.0), X(0.5), X(2.0), X(2.0), ______, ______, ______},//[TYPE_DARK]  
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), X(0.5), ______, ______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(2.0)},//[TYPE_FAIRY] 
