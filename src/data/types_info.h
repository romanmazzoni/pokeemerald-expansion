...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar  GYM1  SHOULEIL  LIGHT   FURRY    ON    MONEY    FAKE    KING    LANCE
    ...
    [TYPE_POISON]   = {______, ______, ______, ______, X(0.5), X(0.5), X(0.5), BUG_RS, X(0.5), X(0.0), ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), ______},//[TYPE_POISON]
    ...
    [TYPE_ELECTRIC] = {______, ______, ______, X(2.0), ______, X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______, ______, ______, X(0.5), X(0.0), ______, ______, ______, ______, ______, X(0.5)},//[TYPE_ELECTRI
    ...
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(2.0)},//[TYPE_FAIRY] 
    ...
    [TYPE_SHOULEIL] = {______, X(0.5), X(0.5), ______, ______, ______, ______, X(2.0), X(2.0), X(0.5), ______, X(2.0), X(2.0), X(0.0), ______, ______, ______, X(0.5), ______, ______, ______, X(0.5), X(2.0), ______, X(0.0), ______, X(2.0), X(2.0), ______, X(0.5)},//[TYPE_SHOULEIL
    ...
    [TYPE_KING]     = {______, X(2.0), ______, ______, X(0.5), ______, X(2.0), ______, ______, X(2.0), ______, ______, ______, ______, ______, X(0.0), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______},//[TYPE_KING]  
    [TYPE_LANCE]    = {______, ______, ______, X(2.0), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, X(2.0), X(2.0), ______, X(0.5), ______, ______, X(0.0), X(2.0), ______},//[TYPE_LANCE] 
