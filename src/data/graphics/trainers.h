...
const u32 gTrainerFrontPic_LeaderBrawny[] = INCBIN_U32("graphics/trainers/front_pics/leader_brawly.4bpp.lz");
const u16 gTrainerPalette_LeaderBrawny[] = INCBIN_U16("graphics/trainers/front_pics/leader_brawly.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BRAWNY, gTrainerFrontPic_LeaderBrawny, gTrainerPalette_LeaderBrawny),
