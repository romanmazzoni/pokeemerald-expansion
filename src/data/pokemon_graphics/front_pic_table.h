const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BLUESTOISE, gMonFrontPic_Bluestoise),
    SPECIES_SPRITE(SHUCKOOL, gMonFrontPic_Shuckool),
    SPECIES_SPRITE(PORYGON4, gMonFrontPic_Porygon4),
    SPECIES_SPRITE(PORYGON5, gMonFrontPic_Porygon5),
    SPECIES_SPRITE(PORYGON6, gMonFrontPic_Porygon6),
    SPECIES_SPRITE(PORYGON7, gMonFrontPic_Porygon7),
