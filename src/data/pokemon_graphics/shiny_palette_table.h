const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BLUESTOISE, gMonShinyPalette_Bluestoise),
    SPECIES_SHINY_PAL(SHUCKOOL, gMonShinyPalette_Shuckool),
    SPECIES_SHINY_PAL(PORYGON4, gMonShinyPalette_Porygon4),
    SPECIES_SHINY_PAL(PORYGON5, gMonShinyPalette_Porygon5),
    SPECIES_SHINY_PAL(PORYGON6, gMonShinyPalette_Porygon6),
    SPECIES_SHINY_PAL(PORYGON7, gMonShinyPalette_Porygon7),
