...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_BLUESTOISE]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7  },
    [SPECIES_SHUCKOOL]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_PORYGON4]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_PORYGON5]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6  },
    [SPECIES_PORYGON6]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6  },
    [SPECIES_PORYGON7]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6  },
 ...
 // Hisuian Forms
    ...
    [SPECIES_TYPHLOSION_HISUIAN]           = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  2 },
