const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BLUESTOISE, gMonPalette_Bluestoise),
    SPECIES_PAL(SHUCKOOL, gMonPalette_Shuckool),
    SPECIES_PAL(PORYGON4, gMonPalette_Porygon4),
    SPECIES_PAL(PORYGON5, gMonPalette_Porygon5),
    SPECIES_PAL(PORYGON6, gMonPalette_Porygon6),
    SPECIES_PAL(PORYGON7, gMonPalette_Porygon7),
