const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BLUESTOISE, gMonBackPic_Bluestoise),
    SPECIES_SPRITE(SHUCKOOL, gMonBackPic_Shuckool),
    SPECIES_SPRITE(PORYGON4, gMonBackPic_Porygon4),
    SPECIES_SPRITE(PORYGON5, gMonBackPic_Porygon5),
    SPECIES_SPRITE(PORYGON6, gMonBackPic_Porygon6),
    SPECIES_SPRITE(PORYGON7, gMonBackPic_Porygon7),
