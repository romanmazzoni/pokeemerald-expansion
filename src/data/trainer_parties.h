...
static const struct TrainerMonItemDefaultMoves sParty_ShellyWeatherInstitute[] = {
    {
    .iv = 50,
    .lvl = 28,
...
static const struct TrainerMonItemDefaultMoves sParty_ShellySeafloorCavern[] = {
    {
    .iv = 100,
    .lvl = 37,
...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_SKILL_SWAP, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 43,
    .species = SPECIES_NOIVERN,
    .moves = {MOVE_SCALD, MOVE_SONIC_BOOM, MOVE_SUPERSONIC, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_BONE_RUSH, MOVE_SUPERPOWER, MOVE_SAND_TOMB, MOVE_SLAM},
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_QUICK_ATTACK, MOVE_STOMP, MOVE_NONE}
    },
    {
    .iv = 50,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .moves = {MOVE_SANDSTORM, MOVE_STOCKPILE, MOVE_SAND_ATTACK, MOVE_LICK}
    },
    {
    .iv = 100,
    .lvl = 25,
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .moves = {MOVE_SONIC_BOOM, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 38,
    .species = SPECIES_SALAMENCE,
    .moves = {MOVE_ASTONISH, MOVE_FAKE_OUT, MOVE_OUTRAGE, MOVE_OVERHEAT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK, MOVE_BRAVE_BIRD, MOVE_FACADE}
    },
    {
    .iv = 100,
    .lvl = 28,
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .moves = {MOVE_ICE_FANG, MOVE_POISON_FANG, MOVE_FEAR, MOVE_FIRE_FANG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .heldItem = ITEM_MOON_STONE,
    .moves = {MOVE_SING, MOVE_ROLLOUT, MOVE_MAGNIDUDE, MOVE_WAKE_UP_SLAP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_TAKE_DOWN, MOVE_WATERFALL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_ME_FIRST, MOVE_LICK, MOVE_MIRROR_MOVE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISON_TAIL, MOVE_SCREECH, MOVE_FEAR, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonCustomized sParty_Jack[] = {
    {
    .iv = 160,
    .lvl = 43,
    ...
    .gender = MALE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Mincatana"),
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SHELL_SMASH, MOVE_X_SCISSOR, MOVE_ACROBATICS, MOVE_FAKE_OUT},
    .ball = BALL_LUXURY
    },
    {
    .iv = 120,
    ...
    .gender = FEMALE,
    .isShiny = FALSE,
    .nickname = COMPOUND_STRING("Mincatana2"),
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_LICK, MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_LEER}
    },
    {
    .iv = 100,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_HIDDEN_POWER, MOVE_PSYSHOCK, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = { //ELITE 4 MEMBER HERE
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_MAGIKARP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_FIRE_PUNCH, MOVE_FIRE_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_EXPLOSION, MOVE_MEGA_KICK, MOVE_STONE_AXE, MOVE_PLUCK}
    },
    {
    .iv = 250,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = { // Last elite 4 member
    {
    .iv = 250,
    .lvl = 53,
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 32,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_EARTHQUAKE, MOVE_YAWN, MOVE_SLACK_OFF, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_GROWL, MOVE_THUNDER}
    },
    {
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .moves = {MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_SPRINGTIDE_STORM, MOVE_FLAMETHROWER}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_HYDREIGON,
    .moves = {MOVE_HYPER_BEAM, MOVE_ICE_BEAM, MOVE_MAGNET_BOMB, MOVE_FLAMETHROWER}
    },
    {
    .iv = 150,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .moves = {MOVE_LOW_KICK, MOVE_HELPING_HAND, MOVE_GLARE, MOVE_LIQUIDATION}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_HOLD_BACK, MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_PSYSHOCK, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 43,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_THUNDERBOLT, MOVE_EARTHQUAKE, MOVE_FLY, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 19,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_TORCH_SONG, MOVE_TACKLE, MOVE_MAGNITUDE, MOVE_NONE}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Clarissa[] = { //stopped here
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_ROSELIA,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    .lvl = 31,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TOXIC, MOVE_THUNDER, MOVE_EXPLOSION, MOVE_SLUDGE_BOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    .lvl = 35,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_RAIN_DANCE, MOVE_SANDSTORM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_THUNDER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 32,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_SURF, MOVE_MEGA_KICK, MOVE_BODY_SLAM, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lucas1[] = { //stopped here
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_SLUGMA,
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .moves = {MOVE_SAND_ATTACK, MOVE_PROTECT, MOVE_BITE, MOVE_EMBER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_SMOG, MOVE_EXPLOSION, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 25,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR5[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_PSYCHO_BOOST, MOVE_ICE_BEAM, MOVE_SUPERPOWER, MOVE_PURSUIT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 35,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_ERUPTION, MOVE_ROLLOUT, MOVE_REST, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .moves = {MOVE_FOCUS_PUNCH, MOVE_ROCK_TOMB, MOVE_SHADOW_SNEAK, MOVE_QUIVER_DANCE}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_TabithaMagmaHideout[] = {
    {
    .iv = 75,
    .lvl = 26,
    .species = SPECIES_COFAGRIGUS,
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 32,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_FIRST_IMPRESSION}
    }
};
...
static const struct TrainerMonCustomized sParty_Leaf[] = {
    ...
    .iv = 255,
    .lvl = 83,
    .nickname = COMPOUND_STRING("Shuckool"),
    .isShiny = TRUE,
    .species = SPECIES_SHUCKLE,
    ...
    .iv = 255,
    .lvl = 84,
    .nickname = COMPOUND_STRING("Choco"),
    .species = SPECIES_CINDERACE,
    ...
    .iv = 255,
    .lvl = 88,
    .nickname = COMPOUND_STRING("SANTA!"),
    .species = SPECIES_DELIBIRD,
...
static const struct TrainerMonItemCustomMoves sParty_Frank[] = {
    ...
    .species = SPECIES_WHIMSICOTT,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_SPORE, MOVE_GROWTH, MOVE_GIGA_DRAIN, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 61,
    .species = SPECIES_BELLOSSOM,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_OUTRAGE, MOVE_FAKE_OUT, MOVE_CONFUSION, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 77,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_TAIL_GLOW, MOVE_FLAMETHROWER, MOVE_DRAGON_BREATH, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 61,
    .species = SPECIES_BEEDRILL,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_KNOCK_OFF, MOVE_POISON_JAB, MOVE_BRICK_BREAK, MOVE_SCALE_SHOT}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_SYLVEON,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_CALM_MIND, MOVE_HYPER_VOICE, MOVE_REST, MOVE_SILVER_WIND}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_LEECH_SEED, MOVE_SURF, MOVE_PROTECT, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brenton[] = {
    ...
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_LAVA_PLUME, MOVE_SUPERPOWER, MOVE_MEGAHORN}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_BEHEMOTH_BASH, MOVE_WOOD_HAMMER, MOVE_SAND_TOMB, MOVE_DESTINY_BOND}
    },
};
static const struct TrainerMonItemCustomMoves sParty_JeffLynne[] = {
    ...
    .species = SPECIES_JIGGLYPUFF,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SING, MOVE_DREAM_EATER, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_MR_MIME,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SING, MOVE_DISARMING_VOICE, MOVE_TORCH_SONG, MOVE_BUG_BUZZ}
    },
    {
    .iv = 255,
    .lvl = 62,
...
static const struct TrainerMonItemCustomMoves sParty_Forest[] = {
    ...
    .species = SPECIES_ORICORIO_PAU,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_REVELATION_DANCE, MOVE_CALM_MIND, MOVE_DARKEST_LARIAT, MOVE_ROOST}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_ORICORIO_POM_POM,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_REVELATION_DANCE, MOVE_CALM_MIND, MOVE_FUSION_BOLT, MOVE_ROOST}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_ORICORIO_SENSU,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_REVELATION_DANCE, MOVE_CALM_MIND, MOVE_FUSION_FLARE, MOVE_ROOST}
    },
};
static const struct TrainerMonItemCustomMoves sParty_Vinnie[] = {
    ...
    .species = SPECIES_CHARIZARD,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAME_WHEEL, MOVE_THUNDER_WAVE, MOVE_CRUNCH, MOVE_BRAVE_BIRD}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_VENUSAUR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LEECH_SEED, MOVE_SLUDGE_BOMB, MOVE_EXPLOSION, MOVE_CRABHAMMER}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_BLASTOISE,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_HYDRO_PUMP, MOVE_RAPID_SPIN, MOVE_SNIPE_SHOT, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .heldItem = ITEM_TOXIC_ORB,
    .moves = {MOVE_FLING, MOVE_FLYING_PRESS, MOVE_CLOSE_COMBAT, MOVE_THRASH}
    },
};
static const struct TrainerMonItemCustomMoves sParty_Dylon[] = {
    ...
    .species = SPECIES_CRABOMINABLE,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_ICE_BEAM, MOVE_FEAR, MOVE_BODY_PRESS}
    },
    {
    .iv = 255,
    .lvl = 61,
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SCALD, MOVE_RECOVER, MOVE_PROTECT, MOVE_ACID_ARMOR}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SOLAR_BEAM, MOVE_SOLAR_BLADE, MOVE_FLAMETHROWER, MOVE_GUNK_SHOT}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CALM_MIND, MOVE_RECOVER, MOVE_AEROBLAST, MOVE_PSYCHIC}
    },
};
