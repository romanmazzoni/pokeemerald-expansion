...
static const struct SpriteFrameImage sPicTable_Brawny[] = {
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 0),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 1),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 2),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 0),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 0),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 1),
    overworld_frame(gObjectEventPic_Brawny, 2, 4, 1),
