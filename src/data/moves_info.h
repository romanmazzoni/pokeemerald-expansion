...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_PAY_DAY] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIALER,
    ...
    [MOVE_FLY] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 110 : 70,
        .type = TYPE_FLYING,
        .accuracy = 90,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FURY_ATTACK] =
    {
        .name = COMPOUND_STRING("Furry Attack"),
        .description = COMPOUND_STRING(
 ...
 //here
    ...
    [MOVE_FURY_SWIPES] =
    {
        .name = COMPOUND_STRING("Furry Swipes"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THIEF] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 40,
        .type = TYPE_SHOULEIL,
        .accuracy = 100,
    ...
    [MOVE_SPIDER_WEB] =
    {
        .name = COMPOUND_STRING("Spiber Web"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNORE] =
    {
        ...
        .effect = EFFECT_SNORE,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 75 : 40,
        .type = TYPE_KING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SWEET_KISS] =
    {
        ...
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_SHOULEIL : TYPE_NORMAL,
        .accuracy = 75,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_BELLY_DRUM] =
    {
        .name = COMPOUND_STRING("Belby Drum"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OUTRAGE] =
    {
        ...
        .type = TYPE_LANCE,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_5 ? 20 : 15,
        .target = MOVE_TARGET_RANDOM,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_FURY_CUTTER] =
    {
        .name = COMPOUND_STRING("Furry Cutter"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONLIGHT] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_LIGHT : TYPE_NORMAL,
        .accuracy = 0,
        .pp = 5,
        .target = MOVE_TARGET_USER,
        .priority = 0,
    ...
    [MOVE_DIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn and strikes next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 85 : 60,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_AIR_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 65 : 55,
        .type = TYPE_FLYING,
        .accuracy = 95,
        .criticalHitStage = 1,
        .pp = 25,
    ...
    [MOVE_FRENZY_PLANT] =
    {
        .name = COMPOUND_STRING("Crazy Plant"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BRINE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_SAME_TYPE,       .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
    ...
    [MOVE_FEINT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 50 : 50,
        .type = TYPE_KING,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_POWER_GEM] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 70,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_STORM_THROW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 40,
        .type = TYPE_FAKE,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_INCINERATE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 30,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_SACRED_SWORD] =
    {
        ...
        .type = TYPE_KING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 ? 20 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_HURRICANE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 120 : 120,
        .type = TYPE_FLYING,
        .accuracy = 70,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FLYING_PRESS] =
    {
        ...
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 120 : 80,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FELL_STINGER] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 70 : 30,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 25,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_WATER_SHURIKEN] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 1,
        .category = B_UPDATED_MOVE_DATA >= GEN_7 ? DAMAGE_CATEGORY_SPECIALER : DAMAGE_CATEGORY_PHYSICAL,
        .contestEffect = CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 130 : 130,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_RAGING_FURY] =
    {
        .name = COMPOUND_STRING("Raging Furry"),
        .description = COMPOUND_STRING(
            "A rampage of 2 to 3 turns\n"
            "that confuses the user."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .type = TYPE_KING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 15 : 15,
        .criticalHitStage = 1,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_BLEAKWIND_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May lower the foe's Speed."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 120 : 95,
        .type = TYPE_FLYING,
        .accuracy = 70,
    ...
    [MOVE_SANDSEAR_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May inflict a burn."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 110 : 95,
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 5,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_HIGHER_HORSEPOWER] =
    {
        .name = COMPOUND_STRING("Higher Horsepower"),
        .description = COMPOUND_STRING(
            "Only a true horse would be\n"
            "able to channel this power."),
        .effect = EFFECT_HIT,
        .power = 140,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_SHEER_WET] =
    {
        .name = COMPOUND_STRING("Sheer Wet"),
        .description = COMPOUND_STRING(
            "Summons the element of wet\n"
            "to annihilate foes."),
        .effect = EFFECT_OHKO,
        .power = 1,
        .type = TYPE_WATER,
    ...
    [MOVE_TURTLE_UP] =
    {
        .name = COMPOUND_STRING("Turtle up"),
        .description = COMPOUND_STRING(
            "Summons pure turtle energy\n"
            "for fun."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_WATER,
