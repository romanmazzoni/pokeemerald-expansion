...
{
    [SPECIES_BULBASAUR]             = {{EVO_LEVEL, 17, SPECIES_IVYSAUR}},
    ...
    [SPECIES_SQUIRTLE]              = {{EVO_LEVEL, 17, SPECIES_WARTORTLE}},
    [SPECIES_WARTORTLE]             = {{EVO_LEVEL, 36, SPECIES_BLASTOISE}},
    [SPECIES_CATERPIE]              = {{EVO_LEVEL, 7, SPECIES_METAPOD}},
    [SPECIES_METAPOD]               = {{EVO_LEVEL, 20, SPECIES_BUTTERFREE}},
    [SPECIES_WEEDLE]                = {{EVO_LEVEL, 7, SPECIES_KAKUNA}},
    [SPECIES_KAKUNA]                = {{EVO_LEVEL, 20, SPECIES_BEEDRILL}},
    ...
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 28, SPECIES_PERSIAN}, 
                                        {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_PERRSERKER}},
    ...
    [SPECIES_RHYDON]                = {{EVO_TRADE_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR},
                                       ...
                                       {EVO_LEVEL, 55, SPECIES_RHYPERIOR}},
#endif
    ...
    [SPECIES_PORYGON2]              = {{EVO_TRADE_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z},
                                       ...
                                       {EVO_LEVEL, 33, SPECIES_PORYGON_Z}},
#endif
    ...
    [SPECIES_CRADILY]                = {{EVO_LEVEL, 40, SPECIES_LILEEP}},
    ...
    [SPECIES_GURDURR]               = {{EVO_TRADE, 0, SPECIES_CONKELDURR},
                                       ...
                                       {EVO_LEVEL, 41, SPECIES_CONKELDURR}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_TRADE_SPECIFIC_MON, SPECIES_SHELMET, SPECIES_ESCAVALIER},
                                        {EVO_LEVEL, 25, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_FERROSEED]             = {{EVO_LEVEL, 38, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 35, SPECIES_KLANG}},
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 47, SPECIES_KLINKLANG}},
    ...
    [SPECIES_LARVESTA]              = {{EVO_LEVEL, 55, SPECIES_VOLCARONA}},
#endif
#if P_GEN_6_POKEMON == TRUE
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 35, SPECIES_TREVENANT},
                                       ...
                                       {EVO_LEVEL, 35, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_LEVEL, 32, SPECIES_GOURGEIST},
    ...
    [SPECIES_MELTAN]               = {{EVO_LEVEL, 36, SPECIES_MELMETAL}},
    ...
    [SPECIES_APPLIN]                = {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_FLAPPLE},
                                       ...
                                       {EVO_LEVEL_NIGHT, 33, SPECIES_APPLETUN},
                                       {EVO_LEVEL_DAY, 33, SPECIES_FLAPPLE}
                                       },
    ...
    [SPECIES_SINISTEA]              = {{EVO_LEVEL, 38, SPECIES_POLTEAGEIST}},
    ...
    [SPECIES_MILCERY]               = {{EVO_LEVEL, 20, SPECIES_ALCREMIE},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_RUBY_CREAM},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_MATCHA_CREAM},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_MINT_CREAM},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_LEMON_CREAM},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_SALTED_CREAM},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_RUBY_SWIRL},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_CARAMEL_SWIRL},
                                       {EVO_LEVEL, 20, SPECIES_ALCREMIE_RAINBOW_SWIRL}},
    [SPECIES_SNOM]                  = {{EVO_FRIENDSHIP, 0, SPECIES_FROSMOTH}},
    ...
    [SPECIES_KUBFU]                 = {{EVO_LEVEL, 45, SPECIES_URSHIFU},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 43, SPECIES_GOLEM_ALOLAN},
    ...
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_LEVEL, 26, SPECIES_SLOWBRO_GALARIAN}},
    [SPECIES_SLOWBRO_GALARIAN]     = {{EVO_LEVEL, 50, SPECIES_SLOWKING_GALARIAN}},
#if P_GEN_8_POKEMON == TRUE
    [SPECIES_FARFETCHD]    = {{EVO_CRITICAL_HITS, 4, SPECIES_SIRFETCHD}},
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_CRITICAL_HITS, 4, SPECIES_SIRFETCHD}},
    [SPECIES_MR_MIME]      = {{EVO_LEVEL, 42, SPECIES_MR_RIME}},
    [SPECIES_MR_MIME_GALARIAN]      = {{EVO_LEVEL, 42, SPECIES_MR_RIME}},
    [SPECIES_CORSOLA]      = {{EVO_LEVEL, 38, SPECIES_CURSOLA}},
    [SPECIES_CORSOLA_GALARIAN]      = {{EVO_LEVEL, 38, SPECIES_CURSOLA}},
    [SPECIES_ZIGZAGOON_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_LINOONE_GALARIAN}},
    [SPECIES_LINOONE]      = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_OBSTAGOON}},
    [SPECIES_LINOONE_GALARIAN]      = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_OBSTAGOON}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 36, SPECIES_GOURGEIST_SMALL},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 36, SPECIES_GOURGEIST_LARGE},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 36, SPECIES_GOURGEIST_SUPER},
    ...
    [SPECIES_SINISTEA_ANTIQUE]      = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_POLTEAGEIST_ANTIQUE},
                                            {EVO_LEVEL, 50, SPECIES_POLTEAGEIST_ANTIQUE}},
    [SPECIES_BASCULIN]              = {{EVO_ITEM_NIGHT, ITEM_PEAT_BLOCK, SPECIES_BASCULEGION},
                                        {EVO_LEVEL, 50, SPECIES_BASCULEGION}},
    [SPECIES_BASCULIN_WHITE_STRIPED]  = {{EVO_ITEM_NIGHT, ITEM_PEAT_BLOCK, SPECIES_BASCULEGION},
                                        {EVO_LEVEL, 50, SPECIES_BASCULEGION}},
    [SPECIES_QWILFISH]      = {{EVO_LEVEL, 34, SPECIES_OVERQWIL}},
    [SPECIES_QWILFISH_HISUIAN]      = {{EVO_LEVEL, 34, SPECIES_OVERQWIL}},
    [SPECIES_STANTLER]      = {{EVO_LEVEL, 37, SPECIES_WYRDEER}},
    [SPECIES_BLASTOISE]     = {{EVO_LEVEL, 55, SPECIES_BLUESTOISE}},
    [SPECIES_SHUCKLE]     = {{EVO_ITEM, ITEM_BLACK_GLASSES, SPECIES_SHUCKOOL}},
    [SPECIES_PORYGON_Z]     = {{EVO_ITEM, ITEM_UPGRADE, SPECIES_PORYGON4}},
    [SPECIES_PORYGON4]     = {{EVO_ITEM, ITEM_UPGRADE, SPECIES_PORYGON5}},
    [SPECIES_PORYGON5]     = {{EVO_ITEM, ITEM_UPGRADE, SPECIES_PORYGON6}},
    [SPECIES_PORYGON6]     = {{EVO_ITEM, ITEM_UPGRADE, SPECIES_PORYGON7}},
#endif
};
