...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_COALOSSAL] =
    {
        ...
        .hotStreak = 56,
        .doubleHit = 41,
        .innates = {ABILITY_ROUGH_SKIN, ABILITY_NO_GUARD, ABILITY_RETURN_FIRE},
    ...
    [SPECIES_MILCERY] =
    {
        ...
        .evolutions = EVOLUTION(
                                {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ALCREMIE_FLOWER_VANILLA_CREAM},
                                {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ALCREMIE_RIBBON_RUBY_CREAM},
                                {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM},
                                {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ALCREMIE_FLOWER_MATCHA_CREAM},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ALCREMIE_FLOWER_MINT_CREAM},
                                {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL},
                                {EVO_ITEM, ITEM_MOON_STONE, SPECIES_ALCREMIE_RIBBON_LEMON_CREAM},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ALCREMIE_FLOWER_RAINBOW_SWIRL},
                                {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ALCREMIE_FLOWER_LEMON_CREAM},
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM},
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    {
        .baseHP        = 92,
        .baseAttack    = P_UPDATED_STATS >= GEN_9 ? 130 : 130,
        .baseDefense   = 115,
        .baseSpeed     = 138,
        .baseSpAttack  = 80,
        .baseSpDefense = 115,
