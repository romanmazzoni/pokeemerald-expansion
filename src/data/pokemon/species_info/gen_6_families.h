...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .hotStreak = 55,
        .doubleHit = 52,
        .innates = {ABILITY_SEED_SOWER, ABILITY_ANTICIPATION},
        .types = MON_TYPES(TYPE_GRASS, TYPE_FAKE),
        .catchRate = 45,
        .expYield = 142,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .hotStreak = 66,
        .doubleHit = 77,
        .innates = {ABILITY_SEED_SOWER, ABILITY_ANTICIPATION, ABILITY_VESSEL_OF_RUIN},
        .types = MON_TYPES(TYPE_GRASS, TYPE_FIGHTING, TYPE_FAKE),
        .catchRate = 45,
    ...
    [SPECIES_BRAIXEN] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 66,
        .innates = {ABILITY_FRIEND_GUARD, ABILITY_CUTE_CHARM},
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .hotStreak = 104,
        .doubleHit = 77,
        .innates = {ABILITY_FRIEND_GUARD, ABILITY_CUTE_CHARM, ABILITY_PSYCHIC_SURGE},
        .types = MON_TYPES(TYPE_FIRE, TYPE_PSYCHIC, TYPE_FURRY),
        .catchRate = 45,
    ...
    [SPECIES_FROGADIER] =
    {
        ...
        .hotStreak = 81,
        .doubleHit = 75,
        .innates = {ABILITY_OWN_TEMPO, ABILITY_WEATHER_SPECIALIST},
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 45,
        .expYield = 142,
        .evYield_Speed = 2,
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .hotStreak = 60,
        .doubleHit = 66,
        .innates = {ABILITY_STAMINA, ABILITY_SUPER_LUCK, ABILITY_IRON_FIST},
        .types = MON_TYPES(TYPE_NORMAL, TYPE_GROUND, TYPE_FAKE),
        .catchRate = 127,
        .expYield = 148,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .hotStreak = 70,
        .doubleHit = 78,
        .innates = {ABILITY_WIMP_OUT, ABILITY_INTIMIDATE},
    ...
    [SPECIES_TALONFLAME] =
    {
        ...
        .hotStreak = 97,
        .doubleHit = 99,
        .innates = {ABILITY_WIMP_OUT, ABILITY_INTIMIDATE, ABILITY_INTIMIDATE2},
        .types = MON_TYPES(TYPE_FIRE, TYPE_FLYING),
        .catchRate = 45,
        .expYield = 175,
        .evYield_Speed = 3,
...
#define SPEWPA_SPECIES_INFO(evolution)                                          \
    {                                                                           \
        ...
        .hotStreak = 40,\
        .doubleHit = 45,\
        .innates = {ABILITY_KNOWER, ABILITY_SAND_VEIL},\
        .types = MON_TYPES(TYPE_BUG),                                           \
        .catchRate = 120,                                                       \
        .expYield = 75,                                                         \
        .evYield_Defense = 2,                                                   \
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        .hotStreak = 102,\
        .doubleHit = 40,\
        .innates = {ABILITY_KNOWER, ABILITY_SAND_VEIL, ABILITY_PARENTAL_BOND},\
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .types = MON_TYPES(TYPE_FIRE, TYPE_NORMAL, TYPE_LIGHT),
        .catchRate = 220,
        .expYield = 74,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .hotStreak = 86,
        .doubleHit = 89,
        .innates = {ABILITY_FLAME_BODY, ABILITY_TECHNICIAN, ABILITY_UNAWARE},
        .types = MON_TYPES(TYPE_FIRE, TYPE_NORMAL, TYPE_LIGHT),
        .catchRate = 65,
        .expYield = 177,
        .evYield_SpAttack = 2,
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        ...
        .hotStreak = 60,\
        .doubleHit = 65,\
        .innates = {ABILITY_CUD_CHEW, ABILITY_GRASS_PELT},\
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_NONE, ABILITY_SYMBIOSIS },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
        ...
        .hotStreak = 60,\
        .doubleHit = 121,\
        .innates = {ABILITY_CUD_CHEW, ABILITY_GRASS_PELT, ABILITY_POISON_HEAL},\
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GRASS, TYPE_LIGHT),                                         \
        .catchRate = 45,                                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_GYM1),
        .catchRate = 200,
        .expYield = 70,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .hotStreak = 75,
        .doubleHit = 78,
        .innates = {ABILITY_HORSE_EATER, ABILITY_HUGE_POWER, ABILITY_FLOWER_GIFT},
        .types = MON_TYPES(TYPE_GRASS, TYPE_GYM1),
        .catchRate = 45,
        .expYield = 186,
        .evYield_HP = 2,
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_LIGHT),
        .catchRate = 220,
        .expYield = 70,
        .evYield_Attack = 1,
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .hotStreak = 67,
        .doubleHit = 78,
        .innates = {ABILITY_PASTEL_VEIL, ABILITY_GLUTTONY, ABILITY_MIRROR_ARMOR},
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_DARK, TYPE_LIGHT),
        .catchRate = 65,
        .expYield = 173,
        .evYield_Attack = 2,
        .itemRare = ITEM_MENTAL_HERB,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .hotStreak = 65,                        \
        .doubleHit = 75,                        \
        .innates = {ABILITY_RECKLESS, ABILITY_NEUTRALIZING_GAS, ABILITY_SUPER_LUCK},                    \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .hotStreak = 64,
        .doubleHit = 59,
        .innates = {ABILITY_AS_ONE_SHADOW_RIDER},
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .hotStreak = 96,
        .doubleHit = 76,
        .innates = {ABILITY_AS_ONE_SHADOW_RIDER, ABILITY_WANDERING_SPIRIT, ABILITY_QUICK_DRAW},
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_SHOULEIL),
        .catchRate = 75,
        .expYield = 163,
        .evYield_Speed = 2,
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .hotStreak = 32,
        .doubleHit = 63,
        .innates = {ABILITY_BATTLE_ARMOR, ABILITY_QUARK_DRIVE},
        .types = MON_TYPES(TYPE_STEEL, TYPE_GHOST),
        .catchRate = 90,
        .expYield = 157,
        .evYield_Defense = 2,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_SHIELD] =
    {
        ...
        .hotStreak = 32,
        .doubleHit = 63,
        .innates = {ABILITY_BATTLE_ARMOR, ABILITY_QUARK_DRIVE, ABILITY_HARVEST},
        .types = MON_TYPES(TYPE_STEEL, TYPE_GHOST, TYPE_LANCE),
        .catchRate = 45,
    ...
    [SPECIES_AEGISLASH_BLADE] =
    {
        ...
        .hotStreak = 32,
        .doubleHit = 63,
        .innates = {ABILITY_BATTLE_ARMOR, ABILITY_QUARK_DRIVE, ABILITY_RIPEN},
        .types = MON_TYPES(TYPE_STEEL, TYPE_GHOST, TYPE_LANCE),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 250 : 234,
    ...
    [SPECIES_AROMATISSE] =
    {
        ...
        .hotStreak = 56,
        .doubleHit = 42,
        .innates = {ABILITY_POISON_TOUCH, ABILITY_MOODY, ABILITY_AFTERMATH},
        .types = MON_TYPES(TYPE_FAIRY, TYPE_GYM1),
        .catchRate = 140,
        .expYield = 162,
        .evYield_HP = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 69,
        .innates = {ABILITY_SHOULEILY_PAYLOAD, ABILITY_MAGIC_GUARD, ABILITY_RIPEN},
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 140,
        .expYield = 168,
        .evYield_Defense = 2,
    ...
    [SPECIES_MALAMAR] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 70,
        .innates = {ABILITY_LIMBER, ABILITY_FLASH_FIRE, ABILITY_TINTED_LENS},
        .types = MON_TYPES(TYPE_DARK, TYPE_PSYCHIC),
        .catchRate = 80,
        .expYield = 169,
        .evYield_Attack = 2,
    ...
    [SPECIES_BARBARACLE] =
    {
        ...
        .hotStreak = 67,
        .doubleHit = 79,
        .innates = {ABILITY_STURDY, ABILITY_ADAPTABILITY, ABILITY_HORSE_EATER},
        .types = MON_TYPES(TYPE_ROCK, TYPE_WATER),
        .catchRate = 45,
        .expYield = 175,
        .evYield_Attack = 2,
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .hotStreak = 63,
        .doubleHit = 53,
        .innates = {ABILITY_IRON_BARBS, ABILITY_FURRY_ABSORB, ABILITY_CONTRARY},
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .hotStreak = 46,
        .doubleHit = 48,
        .innates = {ABILITY_WATER_ABSORB},
        .types = MON_TYPES(TYPE_WATER, TYPE_MONEY),
        .catchRate = 225,
        .expYield = 66,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_CLAWITZER] =
    {
        ...
        .hotStreak = 87,
        .doubleHit = 59,
        .innates = {ABILITY_WATER_ABSORB, ABILITY_MISTY_SURGE, ABILITY_MAGIC_BOUNCE},
        .types = MON_TYPES(TYPE_WATER, TYPE_MONEY),
        .catchRate = 55,
        .expYield = 100,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_HELIOLISK] =
    {
        ...
        .hotStreak = 94,
        .doubleHit = 73,
        .innates = {ABILITY_CUD_CHEW, ABILITY_QUICK_DRAW, ABILITY_SAND_SPIT},
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_NORMAL, TYPE_LIGHT),
        .catchRate = 75,
        .expYield = 168,
        .evYield_Speed = 1,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 81,
        .innates = {ABILITY_TECHNICIAN, ABILITY_BEAST_BOOST, ABILITY_INFILTRATOR},
        .types = MON_TYPES(TYPE_ROCK, TYPE_DRAGON, TYPE_LANCE),
        .catchRate = 45,
        .expYield = 182,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .hotStreak = 54,
        .doubleHit = 41,
        .innates = {ABILITY_GOOD_AS_GOLD},
        .types = MON_TYPES(TYPE_ROCK, TYPE_ICE, TYPE_MONEY),
        .catchRate = 45,
        .expYield = 72,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_AURORUS] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 58,
        .innates = {ABILITY_GOOD_AS_GOLD, ABILITY_MARVEL_SCALE, ABILITY_BEAST_BOOST},
        .types = MON_TYPES(TYPE_ROCK, TYPE_ICE, TYPE_MONEY),
        .catchRate = 45,
        .expYield = 104,
        .evYield_HP = 2,
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .hotStreak = 108,
        .doubleHit = 91,
        .innates = {ABILITY_SIMPLE, ABILITY_NEUROFORCE, ABILITY_FIGHT_BACK},
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .hotStreak = 73,
        .doubleHit = 74,
        .innates = {ABILITY_VOLT_ABSORB, ABILITY_STATIC, ABILITY_COMPETITIVE},
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FAIRY, TYPE_MONEY),
        .catchRate = 180,
        .expYield = 151,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .hotStreak = 52,
        .doubleHit = 49,
        .innates = {ABILITY_NO_MOONBLAST, ABILITY_STICKY_HOLD, ABILITY_DETHRONE},
    ...
    [SPECIES_SLIGGOO] =
    {
        ...
        .hotStreak = 63,
        .doubleHit = 66,
        .innates = {ABILITY_DEFEATIST, ABILITY_RUN_AWAY},
        .types = MON_TYPES(TYPE_DRAGON),
        .catchRate = 45,
        .expYield = 158,
        .evYield_SpDefense = 2,
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .hotStreak = 97,
        .doubleHit = 22,
        .innates = {ABILITY_DEFEATIST, ABILITY_RUN_AWAY, ABILITY_SIMPLE},
        .types = MON_TYPES(TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_GOODRA_HISUI] =
    {
        ...
        .hotStreak = 87,
        .doubleHit = 73,
        .innates = {ABILITY_SIMPLE, ABILITY_HEAVY_METAL, ABILITY_ARMOR_SHREAD},
        .types = MON_TYPES(TYPE_DRAGON, TYPE_STEEL),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_SpDefense = 3,
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .hotStreak = 79,
        .doubleHit = 69,
        .innates = {ABILITY_SOLID_ROCK, ABILITY_SHED_SKIN, ABILITY_BUG_BACK},
        .types = MON_TYPES(TYPE_STEEL, TYPE_FAIRY, TYPE_SHOULEIL),
        .catchRate = 75,
        .expYield = 165,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .hotStreak = 45,
        .doubleHit = 45,
        .innates = {ABILITY_DRY_SKIN, ABILITY_PARENTAL_BOND, ABILITY_VITAL_SPIRIT},
        .types = MON_TYPES(TYPE_GHOST, TYPE_GRASS),
        .catchRate = 60,
        .expYield = 166,
        .evYield_Attack = 2,
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .hotStreak = 70,
        .doubleHit = 74,
        .innates = {ABILITY_PLUS, ABILITY_NEUTRALIZING_GAS, ABILITY_LEAF_GUARD},
        .types = MON_TYPES(TYPE_GHOST, TYPE_GRASS),
        .catchRate = 60,
        .expYield = 173,
        .evYield_Defense = 2,
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .hotStreak = 39,
        .doubleHit = 66,
        .innates = {ABILITY_HORSE_HERO, ABILITY_SOUNDPROOF, ABILITY_FUR_COAT},
        .types = MON_TYPES(TYPE_ICE, TYPE_FURRY),
        .catchRate = 55,
        .expYield = 180,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_AVALUGG_HISUI] =
    {
        ...
        .doubleHit = 66,
        .innates = {ABILITY_HORSE_HERO, ABILITY_SOUNDPROOF, ABILITY_FUR_COAT},
        .types = MON_TYPES(TYPE_ICE, TYPE_ROCK, TYPE_FURRY),
        .catchRate = 55,
        .expYield = 180,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .types = MON_TYPES(TYPE_DARK, TYPE_FAKE),
        .catchRate = 190,
        .expYield = 49,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .hotStreak = 99,
        .doubleHit = 80,
        .innates = {ABILITY_SOUNDPROOF, ABILITY_COMPOUND_EYES, ABILITY_DARK_AURA},
        .types = MON_TYPES(TYPE_DARK, TYPE_DRAGON, TYPE_FAKE),
        .catchRate = 45,
        .expYield = 187,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_XERNEAS_NEUTRAL] =
    {
        ...
        .hotStreak = 110,
        .doubleHit = 104,
        .itemCommon = ITEM_POWER_HERB,
        .innates = {ABILITY_SIMPLE},
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 45,
    ...
    [SPECIES_XERNEAS_ACTIVE] =
    {
        ...
        .doubleHit = 106,
        .itemCommon = ITEM_POWER_HERB,
        .innates = {ABILITY_SIMPLE, ABILITY_DOWNLOAD},
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_HP = 3,
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        .doubleHit = 109,
        .itemCommon = ITEM_POWER_HERB,
        .innates = {ABILITY_INTIMIDATE, ABILITY_INTIMIDATE2},
    ...
    [SPECIES_ZYGARDE_10_AURA_BREAK] =
    {
        ...
        .hotStreak = 93,
        .doubleHit = 98,
        .innates = {ABILITY_GUARD_DOG, ABILITY_WHITE_SMOKE},
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND),
        .catchRate = 3,
    ...
    [SPECIES_ZYGARDE_COMPLETE] =
    {
        ...
        .hotStreak = 86,
        .doubleHit = 89,
        .innates = {ABILITY_GUARD_DOG, ABILITY_WHITE_SMOKE, ABILITY_DOWNLOAD},
        .types = MON_TYPES(TYPE_DRAGON, TYPE_GROUND),
        .catchRate = 3,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .hotStreak = 74,
        .doubleHit = 69,
        .innates = {ABILITY_DAMP, ABILITY_SCREEN_CLEANER, ABILITY_SHIELD_DUST},
        .types = MON_TYPES(TYPE_ROCK, TYPE_FAIRY),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_Defense = 1,
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .hotStreak = 115,
        .doubleHit = 104,
        .innates = {ABILITY_SPEED_BOOST, ABILITY_DARK_AURA, ABILITY_ARMOR_SHREAD},
