...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_JELLICENT] =
    {
        ...
        .hotStreak = 71,
        .doubleHit = 53,
        .innates = {ABILITY_COMPETITIVE, ABILITY_POWER_SPOT, ABILITY_WONDER_SKIN},
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .hotStreak = 82,
        .doubleHit = 71,
        .innates = {ABILITY_BUG_BACK, ABILITY_SOLAR_POWER, ABILITY_SLUSH_RUSH},
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 90,
        .expYield = 169,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON, TYPE_FIRE, TYPE_FURRY),
        .catchRate = 3,
