...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_XATU] =
    {
        ...
        .hotStreak = 86,
        .doubleHit = 79,
        .innates = {ABILITY_DEALTA_STREAM, ABILITY_FIGHT_BACK, ABILITY_LIGHT_METAL},
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FLYING),
        .catchRate = 75,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_URSARING] =
    {
        ...
        .hotStreak = 91,
        .doubleHit = 68,
        .innates = {ABILITY_MAGNENT_PULL, ABILITY_BORING_BLOCKER},
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 60,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .hotStreak = 75,
        .doubleHit = 69,
        .innates = {ABILITY_MAGNENT_PULL, ABILITY_BORING_BLOCKER, ABILITY_STALWART},
