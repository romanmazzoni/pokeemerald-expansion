...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .baseLerAttack = 58,
        .baseLerDefense = 58,
        .critChance = 16, // 1/2 precent of base stat (16 would be normal)
        .armor = 40,
        .trueDamage = 3,
        .luck = 2,        // 1/2 precent of base stat
        .waxing = 10,     // 1/2 precent of base stat
        .gambit = 8,
        .parry = 5,       // 1/2 precent of base stat
        .firstStrike = 1, // 1/2 precent of base stat
        .lifeSteal = 3,   // 1/2 precent of base stat
        .sexism = 10,
        .hotStreak = 12,  
        .doubleHit = 1,   // 1/2 percent of base stat
