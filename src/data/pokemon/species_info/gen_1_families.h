...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_SHOULEIL),
        .catchRate = 45,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .hotStreak = 40,  
        .doubleHit = 20,  
        .innates = {ABILITY_SHELL_ARMOR, ABILITY_STEELY_SPIRIT },
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 120,
        .expYield = 72,
        .evYield_Defense = 2,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .hotStreak = 130,  
        .doubleHit = 30,  
        .innates = {ABILITY_SUPER_LUCK, ABILITY_STEADFAST, ABILITY_HARVEST },
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .hotStreak = 40,  
        .doubleHit = 51,  
        .innates = {ABILITY_POISON_POINT, ABILITY_CUD_CHEW },
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .hotStreak = 70,  
        .doubleHit = 32,  
        .innates = {ABILITY_POISON_POINT, ABILITY_MERCILESS, ABILITY_SNIPER },
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON, TYPE_GYM1),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .hotStreak = 70,  
        .doubleHit = 44,  
        .innates = {ABILITY_VICTORY_STAR, ABILITY_TOUGH_CLAWS},
        .types = MON_TYPES(TYPE_FLYING),
        .catchRate = 120,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .hotStreak = 81,  
        .doubleHit = 53,  
        .innates = {ABILITY_VICTORY_STAR, ABILITY_TOUGH_CLAWS, ABILITY_EARLY_BIRD},
        .types = MON_TYPES(TYPE_FLYING, TYPE_MONEY),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 240,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .hotStreak = 70,  
        .doubleHit = 35,  
        .innates = {ABILITY_FAIRY_AURA, ABILITY_ARMOR_TAIL, ABILITY_STRONG_JAW},
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 127,
    ...
    [SPECIES_RATICATE_ALOLA] =
    {
        ...
        .hotStreak = 70,  
        .doubleHit = 35,  
        .innates = {ABILITY_DARK_AURA, ABILITY_ARMOR_TAIL, ABILITY_STRONG_JAW},
        .types = MON_TYPES(TYPE_DARK, TYPE_NORMAL),
        .catchRate = 127,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 145 : 116,
        .evYield_Speed = 2,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .hotStreak = 69,  
        .doubleHit = 45,  
        .innates = {ABILITY_ADAPTABILITY, ABILITY_INTIMIDATE, ABILITY_ARENA_TRAP},
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING, TYPE_DARK),
        .catchRate = 90,
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .hotStreak = 93,  
        .doubleHit = 33,  
        .innates = {ABILITY_FILTER, ABILITY_GUARD_DOG, ABILITY_LIMBER},
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 90,
    ...
    [SPECIES_PICHU] =
    {
        ...
        .hotStreak = 54,  
        .doubleHit = 14,  
        .innates = {ABILITY_KLUTZ},
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_MONEY),
        .catchRate = 190,
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .hotStreak = 90,  
        .doubleHit = 31,  
        .innates = {ABILITY_LIQUID_VOICE, ABILITY_MAGICIAN},
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_MONEY),
        .catchRate = 190,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .hotStreak = 110,  
        .doubleHit = 40,  
        .innates = {ABILITY_LIQUID_VOICE, ABILITY_MAGICIAN, ABILITY_OPPORTUNIST },
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_MONEY),
        .catchRate = 75,
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .doubleHit = 40,  
        .innates = {ABILITY_LIQUID_VOICE, ABILITY_MAGICIAN, ABILITY_OPPORTUNIST },
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_PSYCHIC, TYPE_MONEY),
        .catchRate = 75,
        .expYield = RAICHU_EXP_YIELD,
        .evYield_Speed = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .hotStreak = 50,  
        .doubleHit = 45,  
        .innates = {ABILITY_SHARPNESS, ABILITY_MINDS_EYE, ABILITY_MERCILESS},
        .types = MON_TYPES(TYPE_GROUND, TYPE_GYM1),
        .catchRate = 90,
    ...
    [SPECIES_SANDSLASH_ALOLA] =
    {
        ...
        .doubleHit = 45,  
        .innates = {ABILITY_SHARPNESS, ABILITY_MINDS_EYE, ABILITY_MERCILESS},
        .types = MON_TYPES(TYPE_ICE, TYPE_STEEL, TYPE_GYM1),
        .catchRate = 90,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 158 : 163,
        .evYield_Defense = 2,
        .itemRare = ITEM_GRIP_CLAW,
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .hotStreak = 60,  
        .doubleHit = 35,  
        .innates = {ABILITY_RUN_AWAY, ABILITY_BULLETPROOF},
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 120,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .hotStreak = 70,  
        .doubleHit = 44,  
        .innates = {ABILITY_MAGMA_ARMOR, ABILITY_BULLETPROOF, ABILITY_QUEENLY_MAJESTY},
        .types = MON_TYPES(TYPE_POISON, TYPE_GROUND, TYPE_KING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 253,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .hotStreak = 45,  
        .doubleHit = 60,  
        .innates = {ABILITY_DANCER, ABILITY_FAIRY_AURA, ABILITY_MARVEL_SCALE},
        .types = CLEFAIRY_FAMILY_TYPES,
        .catchRate = 25,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 242,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .hotStreak = 80,  
        .doubleHit = 50,  
        .innates = {ABILITY_MISTY_SURGE, ABILITY_COSTAR, ABILITY_CURSED_BODY},
    ...
    [SPECIES_NINETALES_ALOLA] =
    {
        ...
        .doubleHit = 50,  
        .innates = {ABILITY_MISTY_SURGE, ABILITY_COSTAR, ABILITY_CURSED_BODY},
        .types = MON_TYPES(TYPE_ICE, TYPE_FAIRY, TYPE_FURRY),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 177 : 178,
        .evYield_Speed = 1,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .hotStreak = 100,  
        .doubleHit = 115,  
        .innates = {ABILITY_FLUFFY, ABILITY_LIGHT_METAL},
        .types = JIGGLYPUFF_FAMILY_TYPES,
        .catchRate = 170,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .hotStreak = 140,  
        .doubleHit = 140,  
        .innates = {ABILITY_HUGE_POWER, ABILITY_LIGHT_METAL, ABILITY_TABLETS_OF_RUIN},
        .types = JIGGLYPUFF_FAMILY_TYPES,
        .catchRate = 50,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 218,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_FLYING, TYPE_GYM1),
        .catchRate = 255,
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .hotStreak = 110,  
        .doubleHit = 40,  
        .innates = {ABILITY_LEVITATE, ABILITY_WANDERING_SPIRIT},
        .types = MON_TYPES(TYPE_POISON, TYPE_FLYING, TYPE_GYM1),
        .catchRate = 90,
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .hotStreak = 130,  
        .doubleHit = 55,  
        .innates = {ABILITY_LEVITATE, ABILITY_WANDERING_SPIRIT, ABILITY_GALE_WINGS},
        .types = MON_TYPES(TYPE_POISON, TYPE_FLYING, TYPE_GYM1),
        .catchRate = 90,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 268,
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .hotStreak = 30,  
        .doubleHit = 44,  
        .innates = {ABILITY_TANGLED_FEET, ABILITY_INSOMNIA},
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 120,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .hotStreak = 34,  
        .doubleHit = 50,  
        .innates = {ABILITY_TANGLED_FEET, ABILITY_POISON_POINT, ABILITY_RIPEN},
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
