...
const u8 *const gStatNamesTable[NUM_BATTLE_STATS] =
{
    ...
    [STAT_CRIT]    = sText_CritChance,
    [STAT_ARMOR]   = sText_Armor,
    [STAT_TRUDMG]  = sText_TrueDamage,
    [STAT_LUCK]    = sText_Luck,
    [STAT_WAXING]  = sText_Waxing,
    [STAT_GAMBIT]  = sText_Gambit,
    [STAT_PARRY]   = sText_Parry,
    [STAT_FIRSTSTRIKE] = sText_FirstStrike,
    [STAT_LIFESTL] = sText_LifeSteal,
    [STAT_SEXISM]  = sText_Sexism,
    [STAT_HOTSTK]  = sText_HotStreak,
    [STAT_DBLHIT]  = sText_DoubleHit,
