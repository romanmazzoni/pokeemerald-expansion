...
static const u8 sText_LerAttack[] = _("Ler Atk");
static const u8 sText_LerDefense[] = _("Ler Def");
static const u8 sText_CritChance[] = _("Crit");
...
static const u8 sText_FirstStrike[] = _("FIRST");
static const u8 sText_LifeSteal[] = _("LifeStl");
static const u8 sText_Sexism[] = _("Sexism");
static const u8 sText_HotStreak[] = _("HotStrk");
static const u8 sText_DoubleHit[] = _("DblHit");
...
const u8 *const gStatNamesTable[NUM_BATTLE_STATS] =
{
    ...
    [STAT_LERATK]  = sText_LerAttack,
    [STAT_LERDEF]  = sText_LerDefense,
    [STAT_CRIT]    = sText_CritChance, //percent
    [STAT_ARMOR]   = sText_Armor,
    [STAT_TRUDMG]  = sText_TrueDamage,
    [STAT_LUCK]    = sText_Luck, //percent
    [STAT_WAXING]  = sText_Waxing, //percent
    [STAT_GAMBIT]  = sText_Gambit,
    [STAT_PARRY]   = sText_Parry, //percent
    [STAT_FIRSTSTRIKE] = sText_FirstStrike, //percent
    [STAT_LIFESTL] = sText_LifeSteal, //percent
    [STAT_SEXISM]  = sText_Sexism, //percent
    [STAT_HOTSTK]  = sText_HotStreak, //heal after ko
    [STAT_DBLHIT]  = sText_DoubleHit, //percent
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened the {B_BUFF1} of all other Pokémon!\p"),
    ...
    [STRINGID_HOTSTREAKPROC]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is on a Hot Streak!"),
    ...
    [STRINGID_LIQUIDOOZELIFESTEALPROC]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} countered lifesteal with LIQUID OOZE!"),
};
