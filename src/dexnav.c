...
static const u8 sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES] =
{
    ...
    [TYPE_GYM1] = TYPE_ICON_PAL_NUM_2,
    [TYPE_SHOULEIL] = TYPE_ICON_PAL_NUM_0,
    [TYPE_LIGHT] = TYPE_ICON_PAL_NUM_1,
    [TYPE_FURRY] = TYPE_ICON_PAL_NUM_2,
    [TYPE_ON] = TYPE_ICON_PAL_NUM_0,
    [TYPE_MONEY] = TYPE_ICON_PAL_NUM_1,
    [TYPE_FAKE] = TYPE_ICON_PAL_NUM_2,
    [TYPE_KING] = TYPE_ICON_PAL_NUM_0,
    [TYPE_LANCE] = TYPE_ICON_PAL_NUM_1,
};
