...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic  ice    dragon  dark    fairy   Furry    Bear   Fruity  Tree   Shuckle  Ugly    Massive Short   King    God     space   stall   loser   evil     fun     nerd    oak     wood    table   bee     cool    fish    hard    fake    train   goofy submissve waffle  ego     wizard  song    tech    snow    smart   stupid  money   dog     cat    pitbull ninja   hmslave   red    blue   scary   sports   soft   sledge exlpode  turtle   dino    dance  sand    human    lava   snake   lance    void   banana   love     old   reverse  ball   water2    hot    death  shroom   fat     light   life    loud     wall   fast   plural  hunt    glass     on    sweet   plague  doctor   joke   viable    101
    ...
    {X(2.0), X(1.0), X(2.0), X(2.0), X(2.0), X(1.0), X(2.0), X(0.5), X(1.0), X(2.0), X(0.5), X(0.5), X(1.0), X(0.5), X(2.0), X(1.0), X(0.5), X(1.0), X(1.0), X(2.0), X(2.0), X(2.0), X(2.0), X(0.0), X(1.0), X(0.5), X(1.0), X(0.5), X(0.5), X(0.5), X(0.5), X(2.0), X(1.0), X(2.0), X(0.0), X(1.0), X(1.0), X(1.0), X(0.0), X(2.0), X(0.5), X(0.5), X(2.0), X(0.5), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(0.0), X(1.0), X(2.0), X(0.5), X(2.0), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(0.5), X(1.0), X(0.5), X(0.5), X(2.0), X(0.5), X(1.0), X(1.0), X(0.5), X(1.0), X(2.0), X(2.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(0.5), X(0.5), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(2.0), X(2.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0)}, //bee
...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic  ice    dragon  dark    fairy   Furry    Bear   Fruity  Tree   Shuckle  Ugly    Massive Short   King    God     space   stall   loser   evil    fun     nerd    oak     wood    table   bee     cool    fish    hard    fake    train   goofy submissve waffle  ego     wizard  song    tech    snow    smart   stupid  money   dog     cat     pitbull ninja   hmslave   red    blue   scary   sports   soft   sledge exlpode  turtle   dino    dance  sand    human    lava   snake   lance    void   banana   love     old   reverse  ball   water2    hot    death  shroom   fat     light   life    loud     wall  fast    plural  hunt    glass     on    sweet   plague  doctor   joke   viable    101
    ...
    {X(2.0), X(1.0), X(0.5), X(1.0), X(2.0), X(2.0), X(1.0), X(0.0), X(2.0), X(1.0), X(0.5), X(0.5), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(0.5), X(0.5), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(2.0), X(2.0), X(1.0), X(0.0), X(1.0), X(1.0), X(0.5), X(1.0), X(2.0), X(1.0), X(1.0), X(0.5), X(0.5), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(0.5), X(0.5), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(0.5), X(0.5), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(0.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(2.0), X(0.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(0.5), X(1.0)}, //lava
...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic  ice    dragon  dark    fairy   Furry    Bear   Fruity  Tree   Shuckle  Ugly    Massive Short   King    God     space   stall   loser   evil    fun     nerd    oak     wood    table   bee     cool    fish    hard    fake    train   goofy submissve waffle  ego     wizard  song    tech    snow    smart   stupid  money   dog     cat     pitbull ninja   hmslave   red    blue   scary   sports   soft   sledge exlpode  turtle   dino    dance  sand    human    lava   snake   lance    void   banana   love     old   reverse  ball   water2    hot    death  shroom   fat     light   life    loud     wall  fast    plural  hunt    glass     on    sweet   plague  doctor   joke   viable    101
    ...
    {X(2.0), X(2.0), X(0.5), X(2.0), X(1.0), X(0.5), X(0.0), X(0.5), X(1.0), X(1.0), X(0.0), X(2.0), X(1.0), X(1.0), X(2.0), X(0.5), X(1.0), X(1.0), X(1.0), X(2.0), X(0.5), X(1.0), X(1.0), X(1.0), X(0.5), X(2.0), X(2.0), X(1.0), X(0.0), X(1.0), X(0.5), X(0.5), X(0.5), X(1.0), X(0.5), X(0.5), X(0.5), X(1.0), X(1.0), X(2.0), X(2.0), X(1.0), X(0.5), X(1.0), X(2.0), X(1.0), X(1.0), X(0.5), X(1.0), X(0.5), X(1.0), X(1.0), X(2.0), X(2.0), X(1.0), X(0.5), X(0.5), X(1.0), X(0.5), X(1.0), X(0.5), X(0.5), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(2.0), X(1.0), X(2.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(0.0), X(2.0), X(1.0), X(1.0)}, //plague
