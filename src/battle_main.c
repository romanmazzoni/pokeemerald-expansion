...
const u8 gTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 1] = //names can only be 6 letters long
{
    ...
    [TYPE_LOVE]       = _("Love"),
    [TYPE_OLD]        = _("Old"),
    [TYPE_REVERSE]    = _("Revers"),
    [TYPE_BALL]       = _("Ball"),
    [TYPE_WATER2 ]    = _("Water2"),
    [TYPE_HOT]        = _("Hot"),
    [TYPE_DEATH]      = _("Death"),
    [TYPE_SHROOM]     = _("Shroom"),
    [TYPE_FAT]        = _("Fat"),
    [TYPE_LIGHT]      = _("Light"),
    [TYPE_LIFE]       = _("Life"),
    [TYPE_LOUD]       = _("Loud"),
    [TYPE_WALL]       = _("Wall"),
    [TYPE_FAST]       = _("Fast"),
    [TYPE_PLURAL]     = _("Plural"),
    [TYPE_HUNT]       = _("Hunt"),
    [TYPE_GLASS]      = _("Glass"),
    [TYPE_ON]         = _("On"),
    [TYPE_SWEET]      = _("Sweet"),
    [TYPE_PLAGUE]     = _("Plague"),
    [TYPE_DOCTOR]     = _("Doctor"),
    [TYPE_JOKE]       = _("Joke"),
    [TYPE_VIABLE]     = _("Viable"),
    [TYPE_101]        = _("101"),
};
...
static u32 GeneratePartyHash(const struct Trainer *trainer, u32 i)
{
    ...
    else if (trainer->partyFlags == F_TRAINER_PARTY_EVERYTHING_CUSTOMIZED)
    {
     ...
     else if (trainer->partyFlags == F_TRAINER_PARTY_MIRROR)
    {
        buffer = (const u8 *) &trainer->party.EverythingCustomized[i];
        n = sizeof(*trainer->party.EverythingCustomized);
    }
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 firstTrainer, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            case F_TRAINER_PARTY_MIRROR: //this is where the first elite 4 member battle is set
            {
                const struct TrainerMonItemCustomMoves *partyData = trainer->party.ItemCustomMoves; 
