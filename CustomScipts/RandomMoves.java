...
public class RandomMoves {
    ...
    // Output is written here — original gen_9.h is never modified.
    private static final String INPUT_PATH =
        "../src/data/pokemon/level_up_learnsets/gen_9.h";
    private static final String OUTPUT_PATH =
        "gen_9_with_random_moves.h";

    public static void main(String[] args) throws IOException {
        Random rng = new Random();
        java.util.regex.Pattern lvlPattern =
            java.util.regex.Pattern.compile("LEVEL_UP_MOVE\\(\\s*(\\d+),");

        List<String> inputLines = Files.readAllLines(Path.of(INPUT_PATH));
        List<String> outputLines = new ArrayList<>(inputLines.size() + 500);

        // Buffer holds lines inside the current learnset (between { and LEVEL_UP_END).
        List<String> buffer = new ArrayList<>();
        boolean inLearnset = false;
        ...
        for (String line : inputLines) {
            if (inLearnset) {
                ...
                // Detect the opening of a learnset array.
                if (line.contains("LevelUpLearnset[] = {")) {
                    inLearnset = true;
                }
            }
        }

        Files.write(Path.of(OUTPUT_PATH), outputLines);
        System.out.println("Done! Wrote " + outputLines.size() + " lines to " + OUTPUT_PATH);
    }
